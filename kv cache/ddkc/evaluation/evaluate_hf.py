...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir", "-s", type=str, default="mmlu_results_qwen_1.5b_v2")
    parser.add_argument("--model", "-m", type=str,default="/home/LAB/lishuo/jerry/DDKC/quan/qwen2_1.5b_v2")
