...
pretrained_model_dir = "/home/incoming/LLM/llama3/llama3-8b-instruct"
quantized_model_dir = "/home/LAB/lishuo/jerry/DDKC/quan_llama38b"


tokenizer = AutoTokenizer.from_pretrained(pretrained_model_dir, use_fast=True,device=device)
examples = [
    tokenizer(
