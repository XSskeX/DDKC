...
def main():
    ...
    parser.add_argument("--pretrained_model_dir", type=str,default="/home/LAB/lishuo/jerry/DDKC/qwen2_1.5b")
    parser.add_argument("--quantized_model_dir", type=str, default="/home/LAB/lishuo/jerry/DDKC/quan/qwen2_1.5b_v2")
